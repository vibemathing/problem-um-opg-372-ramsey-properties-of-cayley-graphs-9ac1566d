...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-372"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-v1",
      "problem_contract_sha256": "382488368d886190f9268178a6fea28aa4a2240ec1cbe3950954fbf7055ca4b4",
      "problem_id": "problem:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d",
      "route_id": "route:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-source-fidelity-01",
      "graph_id": "graph:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture There exists a fixed constant $c$ so that every abelian group $G$ has a subset $S \\subseteq G$ with $-S = S$ so that the Cayley graph ${\\mathit Cayley}(G,S)$ has no clique or independent set of size $> c \\log |G|$."
          },
          "statement_sha256": "d1d8edf367860017dda740a8e72367734e29990d82d930f8583734fd09b92a69"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-root",
      "route_id": "route:um-opg-372-ramsey-properties-of-cayley-graphs-9ac1566d-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-372-bcd858d19080",
        "url": "https://www.unsolvedmath.com/problems/OPG-372"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
